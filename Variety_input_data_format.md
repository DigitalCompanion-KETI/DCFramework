...
`STFT(Short Time Fourier Transform)`이란 시간의 경과에 따라 변하는 로컬 영역 신호의 정현파 주파수 및 위상 내용을 
...
해당 함수 스크립트는 [해당 링크](http://www.frank-zalkow.de/en/code-snippets/create-audio-spectrograms-with-python.html?i=1)를 참고하였습니다.
